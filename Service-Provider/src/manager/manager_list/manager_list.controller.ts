import { Controller, Get, Post, Body, Patch, Param, Delete, Session, UnauthorizedException, UploadedFile, ParseFilePipe, UseInterceptors, MaxFileSizeValidator, FileTypeValidator, UseGuards, Put, UsePipes, ValidationPipe, HttpException, HttpStatus } from '@nestjs/common';
...
export class ManagerListController {
 ...
 /* @Post('/insert')
  ...
  @UseGuards(new SessionGuard())
  @UsePipes(new ValidationPipe())
  async update(@Param('id') id: string, @Body() createManagerListDto: CreateManagerListDto) {
